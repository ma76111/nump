...
function handleHowToWork(userId) {
  ...
  const howToText = 
    ...
    `⚠️ *مهم جداً:* انتظر 9 دقائق أو أكثر بين كل رسالة\n` +
    ...
    `⚠️ *تحذيرات مهمة:*\n` +
    `• انتظر 9 دقائق بين كل رسالة (مهم جداً!)\n` +
    ...
    `• استخدم مؤقت للانتظار 9 دقائق بين الرسائل\n\n` +
    
    `💡 *ملخص سريع:*\n` +
    `احصل على مهمة → أرسل الإعلان (انتظر 9 دقائق بين كل رسالة) → خذ سكرينات → أرسل الإثبات → راجع الصور → احصل على المكافأة`;
