...
function handleHowToWork(userId) {
  ...
  const howToText = 
    ...
    `• ستحصل على نص الإعلان + 50 رقم\n` +
    `• الوقت المتاح: 90 دقيقة\n\n` +
    ...
    `• افتح واتساب\n` +
    `• أرسل الإعلان لكل رقم من الـ 50 رقم\n` +
    ...
    `💡 *ملخص سريع:*\n` +
    `احصل على مهمة → أرسل الإعلان → خذ سكرينات → أرسل الإثبات → راجع الصور → احصل على المكافأة`;
